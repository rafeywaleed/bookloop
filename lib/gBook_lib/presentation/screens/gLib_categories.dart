...
class GLibCategories extends StatelessWidget {
  const GLibCategories({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          itemCount: GLibCategoriesName.length,
          ...
          itemBuilder: (context, index) {
            return GestureDetector(
              onTap: () {
                print(GLibCategoriesName[index]);
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) =>
                            BookList(name: GLibCategoriesName[index])));
              },
              child: Stack(
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(GLibCategoriesImage[index]),
                          fit: BoxFit.cover),
                    ),
                  ),
                  Container(
